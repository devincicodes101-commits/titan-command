...
interface Props {
  ...
  liveTodaysOpportunities?: number | null;
...
export default function CommandBoard({ savedGoals, serviceTitanConnected, liveRevenue, liveRevenueError, liveDeptPerformance, liveCallsRan, liveCloseRateByBU, liveInstallCrewCount, liveMtdSoldHours, liveTodaysOpportunities, refreshedAt }: Props) {
  ...
  useEffect(() => {
    if (liveTodaysOpportunities != null) setInputs((prev) => ({ ...prev, todayOpportunities: liveTodaysOpportunities }));
  }, [liveTodaysOpportunities]);
        ...
        <div className="tf-two-col" style={styles.twoCol}>
          ...
          <section className="tf-card" style={styles.card}>
            ...
            <InputGrid>
              ...
              <NumField label={liveTodaysOpportunities != null ? "Today's Opportunities (Live ⚡)" : "Today's Opportunities"} val={inputs.todayOpportunities} onChange={(v) => setInput("todayOpportunities", v)} step={1} />
...
const styles: Record<string, React.CSSProperties> = {
  ...
  th: { textAlign: "left", color: "var(--tf-muted)", fontSize: "9px", textTransform: "uppercase", letterSpacing: ".04em", padding: "8px 5px", borderBottom: "1px solid rgba(164,140,122,.22)", verticalAlign: "bottom", lineHeight: 1.15 },
  td: { padding: "6px 5px", borderBottom: "1px solid rgba(164,140,122,.12)", verticalAlign: "middle", color: "var(--tf-text)", overflow: "hidden", textOverflow: "ellipsis" },
  tableInput: { width: "100%", boxSizing: "border-box", background: "#0e0e0e", border: "none", borderBottom: "2px solid rgba(86,67,52,.7)", color: "var(--tf-text)", padding: "6px 4px", outline: "none", fontFamily: "'Space Grotesk',Inter,Arial,sans-serif", fontSize: "13px", fontWeight: 800, borderRadius: 0 },
  tableOutput: { fontFamily: "'Space Grotesk',Inter,Arial,sans-serif", fontWeight: 900, fontSize: "13px", whiteSpace: "nowrap" },
  stLocked: { width: "100%", boxSizing: "border-box", padding: "6px 4px", background: "rgba(255,140,0,.06)", border: "1px solid rgba(255,140,0,.20)", color: "var(--tf-text)", fontFamily: "'Space Grotesk',Inter,Arial,sans-serif", fontSize: "13px", fontWeight: 900, textAlign: "center", whiteSpace: "nowrap" },
  lockedCell: { width: "100%", boxSizing: "border-box", padding: "6px 4px", background: "rgba(164,140,122,.08)", border: "1px solid rgba(164,140,122,.18)", color: "var(--tf-muted)", fontFamily: "'Space Grotesk',Inter,Arial,sans-serif", fontSize: "12px", fontWeight: 900, textAlign: "center" },
  pill: { display: "inline-flex", alignItems: "center", justifyContent: "center", width: "100%", boxSizing: "border-box", padding: "5px 4px", border: "1px solid currentColor", fontFamily: "'Space Grotesk',Inter,Arial,sans-serif", fontSize: "10px", fontWeight: 900, textTransform: "uppercase", letterSpacing: ".03em" },
